...
void YOLO::postprocess(const Mat& frame, const vector<Mat>& outs)   // Remove the bounding boxes with low confidence using non-maxima suppression
{
	vector<int> classIds;
...
void YOLO::detect(const Mat& frame)
{
	Mat blob;
